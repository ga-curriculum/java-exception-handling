<h1>
  ...
  <span class="subhead">Exceptions and <code>try</code>-<code>catch</code> Blocks</span>
</h1>
...
> ❓ Have you encountered any errors with `Exception` as part of their name?
...
<!-- tktk this this a note for David to replace this image -->

![](./assets/java-exception-handling-hierachy.png)
<sub><a href="https://howtodoinjava.com/java/exception-handling/checked-vs-unchecked-exceptions-in-java/">Source</a></sub>
...
> ❓ Discuss with the person next to you why we would want to catch multiple types of exceptions.
